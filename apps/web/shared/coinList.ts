...
export const coinList : { market: string; korean_name: string; english_name: string; }[] = [
  {
    "market": "KRW-BTC",
    "korean_name": "비트코인",
  ...
  {
    "market": "KRW-ASM",
    "korean_name": "어셈블 에이아이",
    "english_name": "Assemble AI"
  },
  {
    "market": "KRW-PUNDIX",
    "korean_name": "펀디엑스",
